...
# Create VideoCapture objects for reading the video frames
cap0 = cv2.VideoCapture(f'describe:appsink', cv2.CAP_GSTREAMER)
cap1 = cv2.VideoCapture(f'describe:appsink', cv2.CAP_GSTREAMER)

# Check if VideoCapture objects were opened successfully
